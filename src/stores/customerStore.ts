...
import type { Customer, CustomerFilters, CustomerLedgerEntry, CustomerLedgerSummary } from '../types/customer';
...
export const useCustomerStore = create<CustomerState>()(
  immer((set, get) => ({
    ...
    fetchCustomerDetail: async (id: UUID) => {
      set((s) => { s.loading = true; s.error = null; s.ledger = []; s.summary = null; });
      try {
