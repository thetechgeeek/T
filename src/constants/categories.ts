...
export const TILE_CATEGORIES: { value: TileCategory; labelEn: string; labelHi: string; icon: string }[] = [
...
export const ALL_CATEGORY_OPTION = { value: 'ALL', labelEn: 'All', labelHi: 'सभी', icon: '🔹' } as const;
