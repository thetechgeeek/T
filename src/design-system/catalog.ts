...
export const DESIGN_LIBRARY_PREVIEW_LABELS = [
	...
	'Error boundary — component level / section level',
	...
	'CSV / Excel / JSON export surfaces (current view + full-dataset handoff)',
	...
	'Export to device Files app / save target',
