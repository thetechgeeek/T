...
const OPACITY_XL_DARK = 0.6;
const OPACITY_XL_LIGHT = 0.22;
...
export const SHADOW_IOS = {
	...
	xl: { dark: OPACITY_XL_DARK, light: OPACITY_XL_LIGHT },
} as const;
...
export const SHADOW_OFFSET = {
	...
	md: { width: 0, height: 3 },
	lg: { width: 0, height: 6 },
	xl: { width: 0, height: 10 },
} as const;

export const SHADOW_RADIUS = { xs: 1, sm: 2, md: 6, lg: 12, xl: 18 } as const;

export const ELEVATION = { xs: 1, sm: 2, md: 4, lg: 8, xl: 12 } as const;
