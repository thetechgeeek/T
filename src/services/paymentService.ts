...
export const paymentService = {
  ...
  async fetchPayments(filters: { customer_id?: UUID; supplier_id?: UUID; dateFrom?: string; dateTo?: string }) {
    let query = supabase.from('payments').select('*, customer:customers(name), supplier:suppliers(name)');
