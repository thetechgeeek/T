...
export function Button({
  ...
  const getSizeStyles = () => {
    switch (size) {
      case 'sm': return { height: 36, px: 16, fontSize: theme.typography.sizes.sm };
      case 'lg': return { height: 56, px: 32, fontSize: theme.typography.sizes.lg };
      case 'md':
      default: return { height: 48, px: 24, fontSize: theme.typography.sizes.md };
    }
  };
  ...
  return (
    <TouchableOpacity
      ...
      style={[
        styles.button,
        {
          backgroundColor: isDisabled && !isOutline && variant !== 'ghost' ? c.surfaceVariant : v.bg,
